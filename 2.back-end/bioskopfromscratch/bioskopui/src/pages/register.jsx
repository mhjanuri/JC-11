            ...
            <div>
                <div className=' mt-3 d-flex justify-content-center'>
                    <div style={{width:'500px',border:'1px solid black'}} className='rounded p-2'>
                        ...
                        <div className='p-1' style={{borderBottom:'1px solid black'}}>
                            <input type="password" onChange={this.onConfirmchange} className='username' style={{border:'transparent',width:'100%',fontSize:'20px'}} ref='confirmpassword' placeholder='confirm pass bro'/>
                        </div>
